...
if __name__=="__main__":
    ...
    plt.xticks(size = '12')
    plt.yticks(size = '12')
    plt.savefig('DQN_Accumulated_Reward.png',format = 'png')
    ...
    plt.xticks(size = '12')
    plt.yticks(size = '12')
    plt.savefig('DQN_Steps_per_Episode.png',format = 'png',dpi=1200) 
    ...
    plt.savefig('DQN_Shortest_Path.png',format = 'png')
    ...
    plt.yticks(size = '12')
    plt.gca().set_aspect('equal', adjustable='box')
    plt.savefig('DQN_Final_Path.png',format = 'png')
    plt.show()
