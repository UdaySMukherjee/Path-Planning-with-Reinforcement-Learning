...
class DQNAgent(VisionMixin):
    def __init__(self, env, gamma=0.9, epsilon=0.1, lr=0.001):
        ...
        self.gamma = gamma
        self.epsilon = epsilon
        self.model = DQN(2, env.num_actions).cuda()
...
if __name__ == "__main__":
    ...
    print("\nEvaluation Complete.\nFinal Stats:")
    print("Q-Learning:", get_metrics(q_rewards, q_successes))
    print("SARSA:", get_metrics(sarsa_rewards, sarsa_successes))
    print("DQN:", get_metrics(dqn_rewards, dqn_successes))
